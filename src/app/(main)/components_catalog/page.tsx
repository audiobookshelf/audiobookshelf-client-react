    ...
    <div className="p-8 w-full max-w-7xl mx-auto">
          ...
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <div className="flex items-center gap-4">
              <ContextMenuDropdown 
                ...
                onAction={(action) => alert(`Action: ${action.action}`)}
              />
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <FileInput onChange={(file) => alert(`Selected file: ${file.name}`)}>
              Choose File
            </FileInput>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <FileInput 
              ...
              onChange={(file) => alert(`Selected document: ${file.name}`)}
          ...
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <FileInput 
              accept="*"
              onChange={(file) => alert(`Selected file: ${file.name}`)}
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-800 p-6 rounded-lg">
          ...
          <li><code className="bg-gray-700 px-2 py-1 rounded">FileInput.tsx</code> - File input component with customizable accept types and responsive design</li>
          <li><code className="bg-gray-700 px-2 py-1 rounded">LibraryIcon.tsx</code> - Library icon component using absicons font with validation and fallback</li>
          </ul>
        </div>
      </section>
        ...
        <div className="bg-gray-800 p-6 rounded-lg">
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div>
              ...
              <p className="mb-2">Import: <code className="bg-gray-700 px-2 py-1 rounded">import LoadingSpinner from '@/components/ui/LoadingSpinner'</code></p>
              <p className="mb-2">Props: <code className="bg-gray-700 px-2 py-1 rounded">size</code> (la-sm, la-lg, la-2x, la-3x), <code className="bg-gray-700 px-2 py-1 rounded">dark</code>, <code className="bg-gray-700 px-2 py-1 rounded">color</code>, <code className="bg-gray-700 px-2 py-1 rounded">className</code></p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="mb-2">Import: <code className="bg-gray-700 px-2 py-1 rounded">import FileInput from '@/components/ui/FileInput'</code></p>
              <p className="mb-2">Props: <code className="bg-gray-700 px-2 py-1 rounded">accept</code> (file types to accept), <code className="bg-gray-700 px-2 py-1 rounded">onChange</code> (callback with selected file), <code className="bg-gray-700 px-2 py-1 rounded">children</code> (ReactNode for button content), <code className="bg-gray-700 px-2 py-1 rounded">className</code> (custom CSS classes)</p>
            </div>
            <div>
              <h4 className="font-medium text-white mb-2">LibraryIcon Component</h4>
              <p className="mb-2">Import: <code className="bg-gray-700 px-2 py-1 rounded">import LibraryIcon from '@/components/ui/LibraryIcon'</code></p>
              <p className="mb-2">Props: <code className="bg-gray-700 px-2 py-1 rounded">icon</code> (icon name from absicons, defaults to 'audiobookshelf'), <code className="bg-gray-700 px-2 py-1 rounded">fontSize</code> (CSS font size class, defaults to 'text-lg'), <code className="bg-gray-700 px-2 py-1 rounded">size</code> (5 or 6 for container size, defaults to 5), <code className="bg-gray-700 px-2 py-1 rounded">className</code> (additional CSS classes)</p>
            </div>
          </div>
        </div>
      </section>
