                  ...
                  libraryItem={
                    {
                      ...
                      rssFeed: {
                        ...
                        meta: {
                          ...
                          explicit: selectedPodcast.media.metadata.explicit,
                          feedUrl: 'https://example.com/feed.xml',
                          imageUrl: selectedPodcast.media.metadata.imageUrl || '',
                          language: selectedPodcast.media.metadata.language || 'en',
                          link: 'https://example.com',
                          ownerEmail: null,
                          ownerName: null,
                          preventIndexing: false,
                          title: selectedPodcast.media.metadata.title || 'Podcast Title',
                          type: 'episodic'
                        },
                        createdAt: Date.now(),
                        updatedAt: Date.now()
