                  ...
                  libraryItem={
                    {
                      ...
                      rssFeed: {
                        ...
                        coverPath: selectedBook.media.coverPath ?? '/default-cover.jpg',
                        ...
                        meta: {
                          ...
                          explicit: selectedBook.media.metadata.explicit,
                          feedUrl: 'https://example.com/book-feed.xml',
                          imageUrl: selectedBook.media.coverPath ?? '/default-cover.jpg',
                          language: selectedBook.media.metadata.language ?? 'en',
                          link: 'https://example.com',
                          ownerEmail: null,
                          ownerName: null,
                          preventIndexing: false,
                          title: selectedBook.media.metadata.title ?? 'Unknown Title',
                          type: 'episodic'
                        },
                        createdAt: Date.now(),
                        updatedAt: Date.now()
